...
def get_credentials():
    ...
    Supports two modes:
    1. Service account: GA4_SERVICE_ACCOUNT_SECRET (base64-encoded JSON key)
    2. OAuth: GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REFRESH_TOKEN
    """
    sa_secret = os.environ.get("GA4_SERVICE_ACCOUNT_SECRET")
    if sa_secret:
    ...
    if not all([client_id, client_secret, refresh_token]):
        ...
        print("Required: GA4_SERVICE_ACCOUNT_SECRET (base64 JSON key)")
